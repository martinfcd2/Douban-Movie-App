    ...
    <div v-else>
      ...
      <div class="section-tips">
        ...
        <div class="tip">
          <img
            width="30"
            height="30"
            src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1559656895308&di=659549c667ba3026330be6a7dab81ef7&imgtype=0&src=http%3A%2F%2Fp1.qhimg.com%2Ft019fe80350d046ade8.jpg"
            alt=""
          />
      ...
      <div class="section-movie-celebrities">
        ...
        <ul class="movie-celebrities">
          <li v-for="director in movie.directors" :key="director.id">
            <a href="">
...
export default {
  ...
  methods: {
    ...
    getMovie() {
      this.$http
        .get("/api/db/movie_detail/" + this.$route.params.id)
        .then((res) => {
          this.movie = res.data;
