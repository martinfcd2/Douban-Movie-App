      ...
      footers: [
        {
          ...
          txt: "首页",
          mark: "home",
          normalImg: require("../assets/ic_tab_home_normal.png"),
        ...
        },
        {
          ...
          txt: "书影音",
          mark: "audio",
          normalImg: require("../assets/ic_tab_audio_normal.png"),
        ...
        },
        {
          ...
          txt: "广播",
          mark: "broadcast",
          normalImg: require("../assets/ic_tab_broadcast_normal.png"),
          activeImg: require("../assets/ic_tab_broadcast_active.png"),
        },
        {
          id: 4,
          txt: "小组",
          mark: "group",
          normalImg: require("../assets/ic_tab_group_normal.png"),
          activeImg: require("../assets/ic_tab_group_active.png"),
        },
        {
          id: 5,
          txt: "我的",
          mark: "mine",
          normalImg: require("../assets/ic_tab_mine_normal.png"),
